...
<link rel="alternate" type="text/xml+oembed" href="https://www.xmindonesiatrade.com/id/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fwww.xmindonesiatrade.com%2Fid%2Faccount-types%2Fultra-low&#038;format=xml" />
    ...
    <script>
        var appConfig = {
            ...
            sessionExpirationTime: '2024-04-09T13:10:58+00:00',
...
<div hidden>
    <div>
        <div class="xm_app_barcode_container" id="XMapp-AppStore">
            <div>
                <img width="160" data-logo="https://cloud.xm-cdn.com/static/xm/pages/xmapp/apple-logo-square.svg?v=6c3e01bbe2dd20d21c26ffe17b9b57eb" data-link="https://apps.apple.com/app/xm-trading-point/id1072084799?refererUrl=https://www.xmindonesiatrade.com/id/id/account-types/ultra-low" class="qrcode center-block" alt="">
            </div>
        ...
        <div class="xm_app_barcode_container" id="XMapp-PlayStore">
            <div>
                <img width="160" data-logo="https://cloud.xm-cdn.com/static/xm/pages/xmapp/android-icon.svg?v=e3eafa19936d7826255d47e94da4fb2a" data-link="https://xmws.s3.eu-west-1.amazonaws.com/xm.apk?refererUrl=https://www.xmindonesiatrade.com/id/id/account-types/ultra-low" class="qrcode center-block" alt="">
            </div>
            <div class="xm_app_barcode_text">
...
<div class="navbar-nav__xmapp visible-xs visible-sm">
    <div class="navbar-nav__xmapp--wrapper">
        ...
        <div class="navbar-nav__xmapp--right">
            <a class="navbar-nav__xmapp--link" href="https://apps.apple.com/app/xm-trading-point/id1072084799?refererUrl=https://www.xmindonesiatrade.com/id/id/account-types/ultra-low">
...
<li class="post post-page"><a title="Go to Tipe Akun Trading." href="https://www.xmindonesiatrade.com/id/account-types" class="post post-page">Tipe Akun Trading</a></li>
<li class="post post-page current-item">Ultra Low</li>
                </ol>
            </div>
...
</div><div class="ultra-low">
	<div class="container hero-banner">
		<div class="row">
			<div class="col-md-8">
				<h2>Mengapa membuka akun XM Ultra Low?</h2>
				<img class="img-responsive center-block visible-xs" src="https://cloud.xm-cdn.com/static/xm/pages/ultra-low/banner-img-lg.png?v=8360e27a52c3afe8ac77ea824b06faa4" />
				<blockquote> Akun XM Ultra Low menawarkan trading bebas swap untuk berbagai pilihan instrumen populer seperti <strong>Emas, EURUSD, USDJPY, EURJPY, GBPUSD</strong> dan lainnya. Akun ini juga menawarkan berbagai manfaat: </blockquote>
				<div class="hero-banner__description">
					<ul class="arrows center-xs">
						<li>Tanpa Swap</li>
						<li>Tanpa komisi</li>
						<li>Leverage hingga 1000:1</li>
						<li class="visible-xs visible-sm">Spread pada pasangan utama serendah 0,6 pip</li>
						<li class="visible-xs visible-sm">Perlindungan Saldo Negatif</li>
						<li class="visible-xs visible-sm">Deposit minimum rendah</li>
					</ul>
					<ul class="arrows center-xs hidden-xs hidden-sm">
						<li>Spread pada pasangan utama serendah 0,6 pip</li>
						<li>Perlindungan Saldo Negatif</li>
						<li>Deposit minimum rendah</li>
					</ul>
					<img class="img-responsive visible-sm" src="https://cloud.xm-cdn.com/static/xm/pages/ultra-low/banner-img-lg.png?v=8360e27a52c3afe8ac77ea824b06faa4" />
					<div class="dis30"></div>
				</div>
			</div>
			<div class="col-md-4 visible-md visible-lg">
				<img class="img-responsive center-block" src="https://cloud.xm-cdn.com/static/xm/pages/ultra-low/banner-img-lg.png?v=8360e27a52c3afe8ac77ea824b06faa4" alt="xm zero mobile screenshot" />
			</div>
			<div class="dis35"></div>

			<div class="col-sm-6 text-center">
				<a class="btn btn-solid btn-green btn-block btn-center" href="https://www.xmindonesiatrade.com/id/account-types">
					LIHAT TIPE AKUN				</a>
			</div>
			<div class="visible-xs dis20"></div>

			<div class="col-sm-6 text-center">
				<a class="btn btn-solid btn-red btn-block btn-center" href="https://www.xmindonesiatrade.com/goto/profile/id">
					BUKA AKUN				</a>
			</div>
			<div class="dis20"></div>
		</div>
	...
	<section class="section bottom card">
		<div class="container">
			<div class="zero-account">
				<div class="zero-account__box box text-center">
					<h3 class="red"><strong><span class="red">GOLD</span></strong></h3>
					<i class="xmFont fa-kit fa-xm-gold red"></i>
					<br>BIAYA SWAP					<div class="num"><strong><span class="red">0</span></strong></div>
					<hr class="red" />
				</div>
				<div class="zero-account__box box text-center">
					<h3 class="red"><strong><span class="red">EUR/USD</span></strong></h3>
					<i class="flag-icon eu"></i><i class="flag-icon us"></i>
					<br>BIAYA SWAP					<div class="num"><strong><span class="red">0</span></strong></div>
					<hr class="red" />
				</div>
				<div class="zero-account__box box text-center">
					<h3 class="red"><strong><span class="red">USD/JPY</span></strong></h3>
					<i class="flag-icon us"></i><i class="flag-icon jp"></i>
					<br>BIAYA SWAP					<div class="num"><strong><span class="red">0</span></strong></div>
					<hr class="red" />
				</div>
				<div class="zero-account__box box text-center">
					<h3 class="red"><strong><span class="red">EUR/JPY</span></strong></h3>
					<i class="flag-icon eu"></i><i class="flag-icon jp"></i>
					<br>BIAYA SWAP					<div class="num"><strong><span class="red">0</span></strong></div>
					<hr class="red" />
				</div>
				<div class="zero-account__box box text-center">
					<h3 class="red"><strong><span class="red">GBP/USD</span></strong></h3>
					<i class="flag-icon en"></i><i class="flag-icon us"></i>
					<br>BIAYA SWAP					<div class="num"><strong><span class="red">0</span></strong></div>
					<hr class="red" />
				</div>
			</div>
	...
	<section class="faq">
		<div class="container">
			<div class="row">
				<div class="col-sm-8">
					<h2>Pertanyaan Umum untuk akun XM Ultra Low</h2>
				</div>
					...
					<div id="accordion1" class="panel-group">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h4 class="panel-title">Jika saya sudah memiliki akun XM, dapatkah saya membuka akun XM Ultra Low?</h4>
								<i class="fa pull-right fa-angle-down"></i>
							</div>
							<div id="a1collapse5" class="panel-collapse collapse">
								<div class="panel-body gray">Ya, Anda dapat melakukannya melalui Login Anggota.</div>
							</div>
						</div>

						<div class="panel panel-default">
							<div class="panel-heading">
								<h4 class="panel-title">Berapa leverage maksimum untuk akun XM Ultra Low?</h4>
								<i class="fa pull-right fa-angle-down"></i>
							</div>
							<div id="a1collapse5" class="panel-collapse collapse">
								<div class="panel-body gray">Leverage maksimum adalah 1000:1.</div>
							</div>
						</div>

						<div class="panel panel-default">
							<div class="panel-heading">
								<h4 class="panel-title">Dapatkah saya menggunakan semua platform XM untuk trading dengan akun XM Ultra Low?</h4>
								<i class="fa pull-right fa-angle-down"></i>
							</div>
							<div id="a1collapse5" class="panel-collapse collapse">
								<div class="panel-body gray">Bisa. Anda dapat menggunakan MT4 dan MT5 untuk perangkat Windows, Mac, iPhone, iPad dan Android.</div>
							</div>
						</div>

						<div class="panel panel-default">
							<div class="panel-heading">
								<h4 class="panel-title">Instrumen mana yang dapat ditradingkan dengan akun XM Ultra Low?</h4>
								<i class="fa pull-right fa-angle-down"></i>
							</div>
							<div id="a1collapse5" class="panel-collapse collapse">
								<div class="panel-body gray">Semua instrumen dapat ditradingkan dengan akun XM Ultra Low.</div>
							</div>
						</div>

						<div class="panel panel-default">
							<div class="panel-heading">
								<h4 class="panel-title">Dapatkah saya memindahkan dana dari akun XM ke akun XM Ultra Low?</h4>
								<i class="fa pull-right fa-angle-down"></i>
							</div>
							<div id="a1collapse5" class="panel-collapse collapse">
								<div class="panel-body gray">Bisa. Namun, mohon perhatikan bahwa semua bonus deposit yang diberikan akan dihapus secara proporsional dari akun yang sudah ada dan tidak dapat dipindahkan ke akun XM Ultra Low.</div>
							</div>
						</div>
					</div>
				</div>
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.eu01.nr-data.net","licenseKey":"NRBR-1d4ceb8e146a994d175","applicationID":"99021171,99021191","transactionName":"MhBSZQoZXhFQWkZdWgtac0QLDF8PHlBWG1QGFl9EFgwdFkhJV0caEBlEQxlVXA1G","queueTime":0,"applicationTime":331,"atts":"HldRE0IDTR8=","errorBeacon":"bam.eu01.nr-data.net","agent":""}</script></body>
</html>
